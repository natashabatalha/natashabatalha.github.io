...
fig = Figure(y_range=[-4,4] ,x_range=[-2,20], width = 550, height = 200,
...
div = Div(text="""<big><b>TTHG with <em>gbar=g<sub>f</sub></em></b></big>""")
...
#js_file = open("/Users/natashabatalha/Documents/picaso_derivations/js/TTHG.js",'w')
#js_file.write(js)
#print(tag)
#js_file.close()